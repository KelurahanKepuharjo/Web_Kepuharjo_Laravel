            ...
            <form action="{{ url('simpanberita') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="col">
                        ...
                        <div class="form-group">
                            <input type="date" name="sub_title" class="form-control  @error('sub_title') is-invalid
                ...
                <form action="{{ url('update-berita/' . $value->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <textarea type="text" name="deskripsi"
                            ...
                            value="{{ old('deskripsi', $value->deskripsi) }}" placeholder="Deskripsi"
...
{{-- Modal Hapus --}}
@foreach ($data as $no => $value)
<div class="modal fade" id="modal-hapus{{ $value->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
