        ...
        <ul class="navbar-nav mr-lg-2">
          <li class="nav-item nav-search d-none d-lg-block">
            <div class="input-group">
              ...
              <input type="text" class="form-control" placeholder="Cari Akun.." aria-label="search" aria-describedby="search">
            </div>
          </li>
        </ul>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="suratselesai">Surat Surat Selesai</a></li>
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            <div class="col-sm-12 mb-4 mb-xl-0">
              <h4 class="font-weight-bold text-dark">Master User</h4>
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            ...
            <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Aplikasi Pengajuan Surat Kelurahan Kepuharjo</span>
          </div>
        </footer>
        <!-- partial -->
      </div>
