            ...
            <section class="home section" id="home">
                <div class="home__container container grid">
                    ...
                    <div class="home__data">
                        ...
                        <p class="home__description">Sebagai wujud komitmen dalam memberikan informasi seluas-seluasnya kepada masyarakat. S-Kepuharjo akan mempermudahkan dalam proses pengajuan surat yang dilakukan oleh masyarakat.</p>
            ...
            <section class="about section container" id="about">
                <div class="about__container grid">
                    <div class="about__data">
                        ...
                        <p class="about__description">S-kepuharjo merupakan aplikasi berbasis website dan mobile kepuharjo ini dapat digunakan oleh pihak masyarakat, RT, dan RW serta website khusus untuk pihak Admin Kelurahan yang digunakan untuk menampung surat sekaligus digunakan untuk data master dari masyarakat, dan diharapkan juga aplikasi pengajuan surat untuk masyarakat ini dapat dilakukan dimanapun dan kapanpun sehingga menjadi lebih efektif dan efisien.</p>
                    </div>
            ...
            <section class="services section container" id="services">
                ...
                <div class="services__container grid">
                    <div class="services__data">
                        ...
                        <p class="services__description">Mengajukan surat sekarang jauh lebih mudah, cukup diajukan dimana saja dalam genggaman tangan
                            <div>
                    ...
                    <div class="services__data">
                        ...
                        <p class="services__description">Selain Aplikasi Android anda dapat mengajukan lewat website dan sekarang pengajuan surat jauh lebih mudah</p>
                        <div>
                            <a href="#" class="button button-link">Learn More</a>
                        </div>
                    </div>
            ...
            <div class="contact container" id="contact">
                <div class="contact__container grid">
                    ...
                    <ul class="contact__content grid">
                        <li class="contact__address">Telephone: <span class="contact__information">+6283-1234-12345</span></li>
                        <li class="contact__address">Alamat :  <span class="contact__information">Kec. Lumajang, Kabupaten Lumajang, Jawa Timur 67316</span></li>
                        <li class="contact__address">Email : <span class="contact__information">kel_kepuharjo@lumajangkab.go.id    </span></li>
                    </ul>
