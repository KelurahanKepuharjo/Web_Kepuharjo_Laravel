            ...
            <form action="{{ url('simpankk') }}" method="post">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="number" id="nomor-kartu" name="nokk" class="form-control
                            @error('nokk') is-invalid

                            @enderror" value="{{ old('nokk') }}" placeholder="Nomor KK" autocomplete="off">
                        @error('nokk')
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="nomor-kartu" name="nik" class="form-control
                            ...
                            @enderror" value="{{ old('nik') }}" required="" placeholder="NIK Kepala Keluuarga"
                            autocomplete="off">
                        @error('nik')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group">
                        <input type="text" name="kepala_keluarga" class="form-control
                            ...
                            @enderror" value="{{ old('kepala_keluarga') }}" required=""
                    ...
                    <div class="form-group">
                        <input type="text" name="alamatkk" class="form-control
                            ...
                            @enderror" value="{{ old('alamatkk') }}" required="" placeholder="Alamat"
                            autocomplete="off">
                        @error('alamatkk')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
...
<div class="modal fade" id="modal-hapus{{ $value->no_kk }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                <a type="button" onclick="showNotification()" href="{{ url($value->no_kk . '/hapus-masterkk') }}"
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="nokk" class="form-control
                                    ...
                                    @enderror" value="{{ old('nokk', $value->no_kk) }}" maxlength="50" required=""
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="nomor-kartu" name="nik" class="form-control
                                    ...
                                    @enderror" value="{{ old('nik', $value->nik) }}" required=""
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="kepala_keluarga" class="form-control
                                    ...
                                    @enderror" value="{{ old('kepala_keluarga', $value->nama_lengkap) }}"
                                placeholder="Nama Kepala Keluarga" autocomplete="off">
                            @error('kepala_keluarga')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="alamatkk" class="form-control
                                    ...
                                    @enderror" value="{{ old('alamat', $value->alamat) }}" maxlength="50" required=""
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col">
                                    <label for="">RT</label>
                                    <input type="text" name="rt" value="{{ old('rt', $value->rt) }} " class="form-control
                                                @error('rt')is-invalid
                                ...
                                <div class="col">
                                    <label for="">Kode Pos</label>
                                    <input type="text" name="kdpos" value="{{ $value->kode_pos }}" class="form-control"
                                        placeholder="Kode Pos" autocomplete="off">
                                    @error('rw')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="text" name="kel" class="form-control" placeholder="Kelurahan"
                                        value="{{ $value->kelurahan }}" maxlength="50" required="" autocomplete="off">
                                </div>
                                <div class="col">
                                    <label for="">Kecamatan</label>
                                    <input type="text" name="kec" class="form-control" placeholder="Kecamatan"
                                        value="{{ $value->kecamatan }}" maxlength="50" required="" autocomplete="off">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col">
                                    <label for="">Kabupaten</label>
                                    <input type="text" name="kab" class="form-control" placeholder="Kabupaten"
                                        value="{{ $value->kabupaten }}" maxlength="50" required="" autocomplete="off">
                                </div>
                                <div class="col">
                                    <label for="">Provinsi</label>
                                    <input type="text" name="prov" class="form-control" placeholder="Provinsi"
                                        value="{{ $value->provinsi }}" maxlength="50" required="" autocomplete="off">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">KK Tanggal</label>
                            <input type="date" class="form-control" value="{{ $value->kk_tgl }}" name="tglkk"
                                id="myDate" name="myDate" placeholder="yyyy-mm-dd" min="1000-01-01" max="9999-12-31"
                                autocomplete="off">
                        </div>
                    </div>
                    <div class="modal-footer">
