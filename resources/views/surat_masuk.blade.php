        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nik" class="form-control" value="{{ $value->nomor_surat }}" maxlength="50"
                        required="">
                ...
                <div class="form-group">
                    <label>Status</label>
                    <input type="text" name="status" class="form-control" value="{{ $value->status_perkawinan }}"
                        maxlength="50" required="">
                    <span class="text-danger">
                </div>
                <div class="form-group">
            ...
            <div class="modal-footer">
                <a type="button" class="btn btn-secondary" style="background-color: rgb(0, 189, 0); color: white;"
