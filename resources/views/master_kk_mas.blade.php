                ...
                <form action="{{ url('update-masteruser/' . $value->nik) }}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            @enderror"
                                maxlength="50" placeholder="NIK" autocomplete="off" value="{{ old('nik', $value->nik) }}">
                            @error('nik')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_lengkap"
                                class="form-control @error('nama_lengkap') is-invalid
                                 @enderror"
                                value="{{ old('nama_lengkap', $value->nama_lengkap) }}" maxlength="50" placeholder="Nama Lengkap"
                                autocomplete="off">
                            @error('nama_lengkap')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="row form-group">
                            <div class="col">
                                ...
                                <input type="text" name="tempat_lahir"
                                    ...
                                    @enderror"
                                    value="{{ old('tempat_lahir', $value->tempat_lahir) }}" maxlength="50" placeholder="Tempat Lahir"
                                    autocomplete="off">
                                @error('tempat_lahir')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col">
                                ...
                                <input type="date" name="tgl_lahir"
                                    ...
                                    @enderror"
                                    value="{{ old('tgl_lahir',$value->tgl_lahir) }}" maxlength="50" placeholder="Tanggal Lahir"
                                    autocomplete="off">
                                @error('tgl_lahir')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="pekerjaan"
                                ...
                                @enderror"
                                value="{{ old('pekerjaan', $value->pekerjaan ) }}" maxlength="50" placeholder="Pekerjaan"
                                autocomplete="off">
                            @error('pekerjaan')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="tgl_perkawinan"
                                ...
                                @enderror"
                                value="{{ $value->tgl_perkawinan }}" maxlength="50" placeholder="Tanggal Perkawinan"
                                autocomplete="off">
                        </div>
                        <div class="row form-group">
                            <div class="col">
                        ...
                        <div class="row form-group">
                            <div class="col">
                                ...
                                <input type="text" name="no_paspor"
                                    ...
                                    @enderror"
                                    value="{{ old('no_paspor', $value->no_paspor) }}" maxlength="50" placeholder="No Paspor"
                                    autocomplete="off">
                            </div>
                            <div class="col">
                                <label>No KITAP</label>
                                <input type="text" name="no_kitap"
                                    ...
                                    @enderror"
                                    value="{{ old('no_kitap', $value->no_kitap) }}" maxlength="50" placeholder="No KITAP"
                                    autocomplete="off">
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col">
                                ...
                                <input type="text" name="nama_ayah"
                                    ...
                                    @enderror"
                                    value="{{ old('nama_ayah', $value->nama_ayah) }}" maxlength="50" placeholder="Nama Ayah"
                                    autocomplete="off">
                                @error('nama_ayah')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col">
                                ...
                                <input type="text" name="nama_ibu"
                                    ...
                                    @enderror"
                                    value="{{ old('nama_ibu', $value->nama_ibu) }}" maxlength="50" placeholder="Nama Ibu"
                                    autocomplete="off">
                                @error('nama_ibu')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
