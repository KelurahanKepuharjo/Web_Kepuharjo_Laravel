        ...
        <div class="modal-content">
            ...
            <form action="{{ url('simpanuser') }}" method="post">
                ...
                <div class="modal-body">
                    <input type="hidden" id="input" name="nokk" class="form-control" maxlength="50" required=""
                        value="{{ $nomor_kk }}" autocomplete="off" readonly>
                        ...
                        <div class="col">
                            ...
                            <div class="col">
                                <select class="form-control @error('pendidikan') is-invalid @enderror"
                                    ...
                                    <option value="Diploma IV/Strata I" {{ 'Diploma IV/Strata I'===old('pendidikan')
                                        ? 'selected' : '' }}>
                        ...
                        <div class="col">
                            ...
                            <div class="col">
                                <select class="form-control @error('status_perkawinan') is-invalid @enderror"
                                    value="{{ old('status_perkawinan') }}" name="status_perkawinan" autocomplete="off"
                                    id="exampleFormControlSelect1">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col">
                            ...
                            <input type="text" name="no_kitap"
                                ...
                                value="{{ old('no_kitap') }}" maxlength="50" placeholder="No KITAP" autocomplete="off">
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col">
                        ...
                        <div class="col">
                            ...
                            <input type="text" name="nama_ibu"
                                ...
                                value="{{ old('nama_ibu') }}" maxlength="50" placeholder="Nama Ibu" autocomplete="off">
                            @error('nama_ibu')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nik" class="form-control @error('nik') is-invalid
                            @enderror" maxlength="50" placeholder="NIK" autocomplete="off"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_lengkap" class="form-control @error('nama_lengkap') is-invalid
                                 @enderror" value="{{ old('nama_lengkap', $value->nama_lengkap) }}" maxlength="50"
                    ...
                    <div class="row form-group">
                        <div class="col">
                            ...
                            <input type="text" name="tempat_lahir" class="form-control @error('tempat_lahir') is-invalid
                                    @enderror" value="{{ old('tempat_lahir', $value->tempat_lahir) }}" maxlength="50"
                        ...
                        <div class="col">
                            ...
                            <input type="date" name="tgl_lahir" class="form-control @error('tgl_lahir') is-invalid
                                    @enderror" value="{{ old('tgl_lahir',$value->tgl_lahir) }}" maxlength="50"
                        ...
                        <div class="col">
                            ...
                            <div class="col">
                                <select class="form-control @error('pendidikan') is-invalid
                                    ...
                                    <option value="Belum Tamat SD/Sederajat"
                                        {{ 'Belum Tamat SD/Sederajat'===old('pendidikan') ? 'selected' : '' }}>Belum
                                        Tamat SD/Sederajat</option>
                                    <option value="Tamat SD/Sederajat" {{ 'Tamat SD/Sederajat'===old('pendidikan')
                                    ...
                                    <option value="Diploma I/II" {{ 'Diploma I/II'===old('pendidikan') ? 'selected' : ''
                                        ...
                                        I/II</option>
                                    <option value="Diploma III/S.Muda" {{ 'Diploma III/S.Muda'===old('pendidikan')
                                        ? 'selected' : '' }}>Diploma
                                        III/S.Muda</option>
                                    <option value="Diploma IV/Strata I" {{ 'Diploma IV/Strata I'===old('pendidikan')
                                        ? 'selected' : '' }}>Diploma
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="pekerjaan" class="form-control @error('pekerjaan') is-invalid
                                @enderror" value="{{ old('pekerjaan', $value->pekerjaan ) }}" maxlength="50"
                        ...
                        <div class="col">
                            ...
                            <div class="col">
                                <select class="form-control @error('status_perkawinan') is-invalid
                                    @enderror" name="status_perkawinan" autocomplete="off"
                                    id="exampleFormControlSelect1">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tgl_perkawinan" class="form-control @error('tgl_perkawinan') is-invalid
                                @enderror" value="{{ $value->tgl_perkawinan }}" maxlength="50"
                        ...
                        <div class="col">
                            ...
                            <div class="col">
                                <select class="form-control @error('kewarganegaraan') is-invalid
                                    @enderror" name="kewarganegaraan" autocomplete="off"
                                    id="exampleFormControlSelect1">
                                    <option>
                    ...
                    <div class="row form-group">
                        <div class="col">
                            ...
                            <input type="text" name="no_paspor" class="form-control @error('no_paspor') is-invalid
                                    @enderror" value="{{ old('no_paspor', $value->no_paspor) }}" maxlength="50"
                                placeholder="No Paspor" autocomplete="off">
                        </div>
                        <div class="col">
                            <label>No KITAP</label>
                            <input type="text" name="no_kitap" class="form-control @error('no_kitap') is-invalid
                                    @enderror" value="{{ old('no_kitap', $value->no_kitap) }}" maxlength="50"
                    ...
                    <div class="row form-group">
                        <div class="col">
                            ...
                            <input type="text" name="nama_ayah" class="form-control @error('nama_ayah') is-invalid
                                    @enderror" value="{{ old('nama_ayah', $value->nama_ayah) }}" maxlength="50"
                        ...
                        <div class="col">
                            ...
                            <input type="text" name="nama_ibu" class="form-control @error('nama_ibu') is-invalid
                                    @enderror" value="{{ old('nama_ibu', $value->nama_ibu) }}" maxlength="50"
